...
export const update: { params: ObjectSchema; body: ObjectSchema } = {
  params: Joi.object().keys({
    purchaseOrderId: Joi.required().custom(objectId),
  }),
  body: Joi.object().keys({
    supplierId: Joi.string().custom(objectId),
    invoiceNumber: Joi.string().required(),
...
// updatePoPayment
export const updatePoPayment: { params: ObjectSchema; body: ObjectSchema } = {
  params: Joi.object().keys({
    purchaseOrderId: Joi.required().custom(objectId),
  }),
  body: Joi.object().keys({
...
export const deleteDocument: { params: ObjectSchema } = {
  params: Joi.object().keys({
    purchaseOrderId: Joi.string().custom(objectId),
  }),
}
